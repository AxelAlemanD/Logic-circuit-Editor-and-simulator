package com.upv.pm_2022.iti_27849_u2_equipo_01.OutputControls;
...
public class OutputControl extends Figure {
    ...
    public OutputControl(int id, int x, int y) {
        this.id = id;
        this.xAxies = x;
        this.yAxies = y;
        this.width = 50;
...
//        paint.setStrokeWidth(3f);
    ...
    public void draw(Canvas canvas){
         ...
         *     ----------
         */
        path.lineTo(this.xAxies - 35, this.yAxies +50);
        path.lineTo(this.xAxies - 35, this.yAxies +55);
